...
export const selectFile = async (SendBird:Object, dispatch:Function, channel:Object) => {
    try {
...
export const sendUserMessage = (Inputmessage:String, channel:Object, dispatch:Function, SendBird:Object) => {
